    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.success) {
                ...
                cancelEditRow(id);
                showToast('success', "Thành công!", "Chỉnh sửa thông tin thể loại thành công!");
                hideLoading();
            } else {
                showToast('error', "Không thành công!", "Chỉnh sửa thông tin thể loại không thành công!");
                hideLoading();
            }
        },
        error: function (e) {
...
function deleteCategory(id) {
    ...
    $.ajax({
        ...
        error: function (error) {
            console.log(error);
            showToast('error', "Không thành công!", "Xoá thông tin thể loại không thành công!");
            hideLoading();
        }
    })
}
...
function insertCategory(event) {
    ...
    $.ajax({
        ...
        error: function (e) {
            showToast('error', "Không thành công!", "Thêm thể loại không thành công!");
            hideLoading();
        }
    })
}
